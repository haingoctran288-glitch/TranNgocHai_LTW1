...
<body class="bg-light">
    ...
    $products = [
        ...
        [
            ...
            "price" => 2800000,
            "image" => "https://product.hstatic.net/200000278317/product/iay-da-bong-puma-future-ultimate-energy-cage-tf-107857-01-vang-chanh-1_729dad4d05b946fa80ff9faa645f21f6_master.jpg"
        ],
        [
                            ...
                            <form action="#" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="fullname"
                                                placeholder="Vd: Trần Ngọc Hải" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="radio" name="method" id="call"
                                                value="Gọi điện" checked>
                                            <label class="form-check-label" for="call">Gọi điện trực tiếp</label>
                                        </div>
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="radio" name="method" id="zalo"
                                                value="Zalo">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="message" rows="3"
                                        placeholder="Ví dụ: Mình cần tư vấn size 41 cho chân bè..."></textarea>
                                </div>

                                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                    <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill"><i
                                            class="bi bi-send me-2"></i>Gửi Yêu Cầu</button>
                                    <button type="reset" class="btn btn-light btn-lg px-5 rounded-pill border">Làm
                                        mới</button>
                                </div>
                            </form>
                        </div>
